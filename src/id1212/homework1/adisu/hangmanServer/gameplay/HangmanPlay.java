package id1212.homework1.adisu.hangmanServer.gameplay;

import id1212.homework1.adisu.hangmanServer.filehandler.FileHandler;
...
public class HangmanPlay {
    ...
    public synchronized int updateUnderline(char guess) {
        String wordFound = "";
        int state = 0;
        for (int i = 0; i < randomWord.length(); i++) {
